...
<body>
	...
	<form id="Form1" name="Form1" action="${pageContext.request.contextPath}/adminSearchProductList" method="post">
		...
		<table style="margin-top:10px" cellSpacing="1" cellPadding="0" width="100%" align="center"
			...
			<TBODY>
				<tr>
					<td class="ta_01" align="center" bgColor="#afd1f3"><strong>教师选课列表</strong>
					</TD>
				</tr>
				<tr>
					<td class="ta_01" align="right">
						<button type="button" id="add" name="add" value="添加"
							class="button_add" onclick="addCourse()"> 添加教师选课</button>
							...
							<c:forEach items="${list }" var="list" varStatus="vs">
								...
								<tr onmouseover="this.style.backgroundColor = 'white'"
									...
									<td style="CURSOR: hand; HEIGHT: 22px" align="center"
										width="3%">${vs.count }</td>
									<td style="CURSOR: hand; HEIGHT: 22px" align="center"
										width="6%">${list.peopleName }</td>
									<td style="CURSOR: hand; HEIGHT: 22px" align="center"
										width="8%">${list.courseName }</td>	
