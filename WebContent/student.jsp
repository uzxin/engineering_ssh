...
<script type="text/javascript">
			...
			function delStudent(sid){
				...
				if(isDel){
					//要删除
					location.href = "${pageContext.request.contextPath}/studentAction_del?sid="+sid;
				}
			}
		</script>
</HEAD>
				...
				<tr>
					<td class="ta_01" align="right">
						<button type="button" id="add" name="add" value="添加"
							class="button_add" onclick="addStudent()"> 添加学生</button>
							...
							<c:forEach items="${studentList }" var="student" varStatus="vs">
								...
								<tr onmouseover="this.style.backgroundColor = 'white'"
									...
									<td style="CURSOR: hand; HEIGHT: 22px" align="center"
										width="3%">${vs.count }</td>
									<td style="CURSOR: hand; HEIGHT: 22px" align="center"
										width="6%">${student.realname }</td>
									<td style="CURSOR: hand; HEIGHT: 22px" align="center"
										width="5%">${student.username }</td>
									<td style="CURSOR: hand; HEIGHT: 22px" align="center"
										width="5%">${student.password }</td>
									<td align="center" style="HEIGHT: 2px"><a
										href="${ pageContext.request.contextPath }/studentAction_edit?sid=${student.sid}">
											<img
									...
									<td align="center" style="HEIGHT: 2px">
										<a href="javascript:void(0);" onclick="delStudent('${student.sid}')"> 
